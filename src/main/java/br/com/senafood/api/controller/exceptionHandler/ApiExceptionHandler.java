...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public static final String MSG_ERRO_GENERICA_USUARIO_FINAL = "Ocorreu um erro interno inesperado no sistema. Tente novamente e se o problema " +
            "persistir, entre em contato com o administrador do sitema.";
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers,
        ...
        String detail = String.format("Um ou mais campos estao invalidos. Faca o preenchimento correto e tente novamento.");
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex,
        ...
        Problem problem = createProblemBuilder(status, problemType, detail)
                .frontMessage(MSG_ERRO_GENERICA_USUARIO_FINAL)
                .build();
    ...
    private ResponseEntity<Object> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException ex,
        ...
        String detail = String.format("O parametro de URL '%s' recebeu o valor '%s', que e de um tipo invalido. " +
                "Corrija e informe um valor compativel com o tipo %s.",ex.getName(),
    ...
    public ResponseEntity<?> handleExceptionNaoTratada(
